# Vendored unmodified from Bench2DriveZoo/team_code/pid_controller.py
# (TCP/VAD closed-loop controller, Apache-2.0 / Bench2Drive project).
# Waypoint convention: index [0] = lateral (right-positive), [1] = forward;
# straight-ahead aim is (0, +d). desired_speed assumes 0.5 s waypoint spacing.
