# Vendored from Bench2DriveZoo/team_code/planner.py; Plotter/debug drawing removed, logic unchanged.
...
class RoutePlanner(object):
    def __init__(self, min_distance, max_distance, lat_ref=42.0, lon_ref=2.0):
        self.route = deque()
